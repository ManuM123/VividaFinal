...
alter table public.gse_assessments drop constraint if exists gse_assessments_phase_check;
alter table public.gse_assessments drop constraint if exists gse_phase_check;
alter table public.gse_assessments
  add constraint gse_phase_check check (phase in ('baseline'));
...
alter table public.check_ins drop column if exists transcript;
alter table public.check_ins drop column if exists recording_id;
alter table public.check_ins drop column if exists exercise_script;
alter table public.check_ins drop column if exists raw_response;
alter table public.check_ins drop constraint if exists check_ins_predicted_state_check;
alter table public.check_ins
  add constraint check_ins_predicted_state_check
  check (predicted_state in ('threat', 'drive', 'soothing'));
